...
$sql="select * from CT_monthly order by year_number desc, month_number desc";
$result=mysql_query($sql);
while($row=mysql_fetch_array($result)){
   ?>
	
   <form action="process_ct_history.php" method="post"><br />
   <a href="#">
   <?php 
   echo '';
   echo $row['date']; 
   ...
   ?>
	...
	<input name="month" type="hidden" value="<?php echo $row['month_number']?>" />
	<input name="year" type="hidden" value="<?php echo $row['year_number']?>" />
